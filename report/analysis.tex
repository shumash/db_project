...
\caption{A graph demonstrating how $c_o$ changes with $i$ and $p$ for $m=100$ and $n=10$.  Note the line of discontinuity where $p = 357.3 i$ - this is the line where the minimum costs switch.}
\label{fig:optcost}
\end{figure}
